                ...
                <div class="steps">
                    ...
                    <fieldset class="step" data-step="6">
                        ...
                        <div class="field">
                            ...
                            <input type="email" id="email" name="email" autocomplete="email" data-required data-pattern="^(?!.*\.\.)[A-Za-z0-9._%+-]+@[A-Za-z0-9-]+(\.[A-Za-z0-9-]+)*\.[A-Za-z]{2,}$" data-error-text="Enter a valid email address.">
